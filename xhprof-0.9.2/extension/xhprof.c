...
# include <sched.h>
/* AR: cpu_set_t not defined yet in my version, seems to map to cpumask_t kernel param,
 * nor are the sched_* calls... stub them out. */
# define cpu_set_t uint64
# define SET_AFFINITY(pid, size, mask) 0
# define GET_AFFINITY(pid, size, mask) 0
# define CPU_ZERO(p) 0
# define CPU_SET(p,b) 0
